...
RSpec.describe ComicsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested comic as @comic" do
      comic = Comic.create! valid_attributes
      get :show, params: {id: comic.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested comic as @comic" do
      comic = Comic.create! valid_attributes
      get :edit, params: {id: comic.to_param}, session: valid_session
      expect(assigns(:comic)).to eq(comic)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Comic" do
        expect {
          post :create, params: {comic: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved comic as @comic" do
        post :create, params: {comic: invalid_attributes}, session: valid_session
        expect(assigns(:comic)).to be_a_new(Comic)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested comic" do
        comic = Comic.create! valid_attributes
        put :update, params: {id: comic.to_param, comic: new_attributes}, session: valid_session
        comic.reload
      ...
      it "assigns the requested comic as @comic" do
        comic = Comic.create! valid_attributes
        put :update, params: {id: comic.to_param, comic: valid_attributes}, session: valid_session
        expect(assigns(:comic)).to eq(comic)
      end
    ...
    context "with invalid params" do
      it "assigns the comic as @comic" do
        comic = Comic.create! valid_attributes
        put :update, params: {id: comic.to_param, comic: invalid_attributes}, session: valid_session
        expect(assigns(:comic)).to eq(comic)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested comic" do
      comic = Comic.create! valid_attributes
      expect {
        delete :destroy, params: {id: comic.to_param}, session: valid_session
      }.to change(Comic, :count).by(-1)
    end
